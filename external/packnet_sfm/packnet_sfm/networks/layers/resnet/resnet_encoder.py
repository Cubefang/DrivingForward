...
class ResnetEncoder(nn.Module):
    ...
    def __init__(self, num_layers, pretrained, num_input_images=1):
        ...
        if num_input_images > 1:
            ...
            # Compatible with both old and new torchvision API
            try:
                # New API (torchvision >= 0.13): use weights parameter
                ...
                weights_map = {
                    ...
                    152: ResNet152_Weights.IMAGENET1K_V1 if pretrained else None,
                }
                self.encoder = resnets[num_layers](weights=weights_map[num_layers])
            except (ImportError, AttributeError):
                # Old API (torchvision < 0.13): use pretrained parameter
